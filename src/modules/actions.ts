...
export const fetchKnowledgeInit = createAction('FETCH_KNOWLEDGE_INIT');
export const fetchKnowledgeDone = createAction('FETCH_KNOWLEDGE_DONE');
export const fetchKnowledgeError = createAction('FETCH_KNOWLEDGE_ERROR');
